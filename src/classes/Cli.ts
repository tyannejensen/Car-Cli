    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          // Call the findVehicleToTow method to find a vehicle to tow and pass the selected truck as 
          // an argument. After calling the findVehicleToTow method, you will need to return to avoid 
          //instantly calling the performActions method again since findVehicleToTow is asynchronous.
        } else if(answers.action === 'Tow') {
          let selectedVehicle = this.vehicles.find(vehicle => vehicle.vin === this.selectedVehicleVin);
          if (selectedVehicle) {
            if (selectedVehicle.constructor.name === 'Truck') {
